...
> Make sure to follow the best practices regarding error handling and add a line that smake the gulp plugin re-emit the first error caught during the transformation of the content.
