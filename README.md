...
__Most new versions of node support most features that Babel provides, except the `import`/`export` syntax. When only that syntax is desired, rename to `gulpfile.esm.js`, install the [esm](https://github.com/standard-things/esm) module, and skip the Babel portion below.__
